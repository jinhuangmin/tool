...
class foreground {
	...
	final public function check_one() {
		...
		$shou=$zxn_user_mulu_db->get_one(array('UserName'=>$_username,'dangqian'=>0));
		if(!$shou){
			$xie=$zxn_user_mulu_db->insert(array('UserName'=>$_username,'dangqian'=>'0','fu'=>'x','name'=>'我的存档'),true);
			if(!$xie){return false;}else{return true;}
			}else{return true;}
		}
	/**
	 * 
