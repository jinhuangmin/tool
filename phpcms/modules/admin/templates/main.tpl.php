...
<div class="col-2 lf mr10" style="width:48%">
	<h6>关于</h6>
	<div class="content">
	开发：<?php echo $product_copyright?><br />
	网站：<a href="http://guop.cn/" target="_blank">http://guop.cn/</a> <br />
	社区：<a href="http://bbs.guop.cn/" target="_blank">http://bbs.guop.cn/</a> <br />
	QQ：3439114969 <br />
	BUG提交：3439114969@qq.com
	</div>
</div>
...
<div class="col-2 col-auto">
	...
	关于后台修改以及PHPCMS相关问题不回复<br />
	自行修改后台导致的任何问题不回复也不帮处理,请覆盖文件并重装网站系统 <br />
    版权信息请勿修改,内置定期校验机制, 版权信息行为将被记录<br />
    内置提交机制,泄漏/转售源码的行为将被记录 <br />
	</div>
</div>
    <div class="bk10"></div>
</div>
