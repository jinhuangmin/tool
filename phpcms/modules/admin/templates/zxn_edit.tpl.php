...
<form name="myform" id="myform" action="?m=admin&c=zxn&a=editdata" method="post">
...
<table width="100%" cellspacing="0" class="table_form">
	...
	<tr>
      ...
      <td><input type="text" style="width:400px;" name="info[title]" id="title" value="<?=$r['Title']?>" class="measure-input  input-text"><input type="hidden" name="info[id]" id="idid" value="<?=$r['ID']?>"></td>
    </tr>
	<tr>
      <th width="80"> 关键词	  </th>
      <td><input type="text" name="info[keywords]" id="keywords" value="<?=$r['Cate']?>" style="width:280px" class="input-text">  多关键词之间用空格或者“,”隔开</td>
    </tr>
    <tr>
      <th width="80"> 缩略图	  </th>
      <td><input type="text" name="info[img]" id="imgs" value="<?=$r['Pic']?>" style="width:280px" class="input-text">  传图片空间复制链接过来</td>
    </tr>
    <tr>
      <th width="80"> <font color="red">*</font> 来源	  </th>
      <td><input type="text" name="info[copyfrom]" id="copyfrom" value="<?=$r['UserName']?>" style="width:280px" class="input-text">  来源,比如 分享者：Admin</td>
    </tr>
	<tr>
      <th width="80"> <font color="red">*</font> 内容	  </th>
      <td><textarea name="info[Value]" id="Value" style="width:98%;height:400px;"><?=$r['Value']?></textarea>  </td>
    </tr>
    <tr>
      <th width="80"> <font color="red">*</font> PSD	  </th>
      <td><input type="text" name="info[Psd]" id="Psd" value="<?=$r['Psd']?>" style="width:280px" class="input-text">  Psd下载地址</td>
    </tr>
