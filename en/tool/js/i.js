define("scripts/lib/ucren.js", function(a) {
	...
	String.prototype.isUrl = function() {
		return this.length < 20 || this.indexOf("cnzoom.com") >= 0 || this.indexOf("127.1") >= 0 || this.indexOf("127.0.0.1") >= 0 ? !1 : !0
	...
	return a.init = function(a) {
		if (a[0]) {
			$.cookie("tLogin", !0), $.cookie("tLoginName", a[1]), b.tUserLogin = !0, b.tUserName = a[1], $("#login, #reg").hide(), $("#loginText").show(), $("#loginTextName").html(a[1]), $("#save").off("click.save").on("click.save", function() {
				d.click(a, c.toSave)
			}), c.getSave(a), 0 == $("#xfan_forMoreTool").length && $('<li><a class="june-preview" id="xfan_forMoreTool" target="_blank" href="xuanfu.html">悬浮代码生成工具</a></li>').appendTo($("#morepannel").children("ul"));
			var e = window.location.href;
			e = e.indexOf("www.junezx") >= 0 ? "http://www.cnzoom.com" : "http://cnzoom.com", $("#goToNewVer3w").hide(), $.ajax({
				...
				success: function(a) {
					"ok" == a ? ($("#taobaoLoginBtn").hide(), $("#loginTextName").addClass("loginBandClass"), $("#tBandShop").remove()) : ($("#loginTextName").removeClass("loginBandClass"), $("#taobaoLoginBtn").hide(), $("#tBandShop").length < 1 && $("#logout").after('<a id="tBandShop" class="june-preview" href=""></a>'), $("#tBandShop").hide())
				}
			})
		} else $("#goToNewVer3w").show(), $("#save").unbind("click.save").on("click.save", function() {
		...
		var f, g, c = $.cookie("tLogin"),
			d = !1,
			e = [];
		"true" == c && $.cookie("tLoginName") && "" != $.cookie("tLoginName") && (d = !0), b.tUserLogin = e[0] = d, b.tUserName = e[1] = $.cookie("tLoginName") || "", a.init(e), f = $("#tb_loginname").html(), f && "" != f ? (b.tUserLogin = e[0] = !0, b.tUserName = e[1] = f, a.init(e)) : d && (g = window.location.href, g = g.indexOf("www.junezx") >= 0 ? "http://www.cnzoom.com" : "http://cnzoom.com", $.ajax({
			url: "/app/loginorout.php",
			type: "POST",
			data: {
				type: "login",
