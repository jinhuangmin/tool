...
function submitColor(a, b, c) {
	...
	"" != b ? a.css("background-color", b) : "" != c ? a.css("background-color", c) : a.css("background-color", "none")
...
define("scripts/little.js", function(a) {
	...
	return tnaCheck("junezx_tna_cs1") || $("#courseStep1").show(), a.click = function(a) {
	...
	return a.thumbImport = function(a) {
	...
	}, a.sharecode = function(a, c) {

		var f, g, h, i, j, d = $("#june"),

			e = c;

		$("#junebox").scrollTop(0).scrollLeft(0), b.tLoading(!0), "rePair" != a ? b.tUserLogin && "" != b.tUserName ? (b.insertID && "" != b.insertID && (b.tLoading(!1), b.tMessage('提交成功, 您的作品地址为: <a class="june-preview" href="http://www.cnzoom.com/new/previewP.php?ID=' + b.insertID + '" target="_blank">http://www.cnzoom.com/new/previewP.php?ID=' + b.insertID + "</a>,您可以将此地址发给您的好友！审核成功后可以加入案例")), $.post("getsnap.php", {
			...
			b.insertID && "" != b.insertID || (b.tLoading(!1), b.tMessage(a[1])), $(e.target).css("visibility", "hidden")
			...
			success: function(a) {
				...
				a ? (b.tLoading(!1), b.tMessage('分享成功, 您的作品地址为: <a class="june-preview" href="http://www.cnzoom.com/new/previewP.php?ID=' + a + '" target="_blank">http://www.cnzoom.com/new/previewP.php?ID=' + a + "</a>,您可以将此地址发给您的好友！"), $.post("getsnap.php", {
		...
		}) : (d.css("position", "fixed"), f = d.offset().top, g = d.offset().left, h = {}, i = d.css("backgroundImage").replace(/^url|[\(\"\)]*/g, ""), checkUrl(i) && (h.top = f, h.left = g, h.right = g + d.width(), h.bottom = f + d.height()), d.find(".t-app, .t-app-child").each(function() {

			var d, e, a = $(this),

				c = a.offset();

			c && !a.is(":hidden") && "jspbChild" != a.attr("data-attachType") && (d = c.left + a.width(), e = c.top + a.height(), (!h.left && 0 != h.left || c.left < h.left) && (h.left = c.left), (!h.right || d > h.right) && (h.right = d), (!h.top && 0 != h.top || c.top < h.top) && (h.top = c.top), (!h.bottom || e > h.bottom) && (h.bottom = e, b.jSelectsedDom.removeClass(b.selectedVal), b.jSelectsedDom = $(), a.addClass(b.selectedVal), b.jSelectsedDom = b.jSelectsedDom.add(a)))

		}), h.left -= g, h.right -= g, h.top -= f, h.bottom -= f, (h.right - h.left) * (h.bottom - h.top) > 2073600 && (h.bottom = h.top + 1080), (h.right - h.left) * (h.bottom - h.top) > 2073600 && (h.right = h.left + 1920), h.left < 0 && (h.left = 0), h.top < 0 && (h.top = 0), h.right > d.width() && (h.right = d.width()), h.bottom > d.height() && (h.bottom = d.height()), h.width = h.right - h.left, h.height = h.bottom - h.top, j = window.location.hash.replace("#", ""), "" != j && "i" == j.substr(0, 1) && (j = j.substr(2), html2canvas(d[0], {
			...
			onrendered: function(a) {
				...
				d.css("position", "relative"), $.post("getsnap-repair.php", {
					...
					b.tLoading(!1), b.tMessage(a[1]), $(e.target).css("visibility", "hidden")
		...
		d[0] && (e = d[0]), d[1] && (f = d[1]), d[2] && (g = d[2]), d[3] && (othsAppID = d[3]), "thumbset" == e ? a.thumbset(g, f) : "sharecode" == e ? a.sharecode(f, b) : "savecode" == e ? a.savecode(f) : "categorychange" == e ? a.categorychange(f, g, othsAppID) : "zdycontrol" == e ? a.zdycontrol(f) : "itemtextset" == e ? a.itemtextset(g, f, b) : "thumbcircleset" == e ? a.thumbcircleset(g, f) : "qsset" == e && a.qsset(f)
	...
	return a.filterTextarea = function(a) {
		...
		c.length > 0 && c.each(function() {
			...
			"" != c && (c = c.replace(/(\<div\s*class\=\"rel\"\s*data-title\=\"([^\"]*)\"\s*style\=\"([^\"]*)\"(\s*data-rn\=\"([^\"]*)\")?)/g, function(a, c, g, h, i, j) {
	...
	return require("scripts/action"), require("scripts/layer"), b.appConfig, b.pencilLine = null, b.pencilStartTime = null, b.pencilThick = 1, $('<div id="pencilDefaultSet" style="z-index: 8002;"><div class="pencil-head"></div><div class="pencil-title">铅笔工具设置面板</div><ul><li><label class="pencil-label-1 pencil-radio-1 selected" for="pencilStyle0" title="实线"></label><input class="pencil-radio" type="radio" name="pencilStyle" id="pencilStyle0" checked="checked" value="solid"><label class="pencil-label-1 pencil-radio-2" for="pencilStyle1" title="虚线"></label><input class="pencil-radio" type="radio" name="pencilStyle" id="pencilStyle1" value="dashed"><label class="pencil-label-1 pencil-radio-3" for="pencilStyle2" title="点状线"></label><input class="pencil-radio" type="radio" name="pencilStyle" id="pencilStyle2" value="dotted"></li><li><label class="pencil-label-2" for="pencilDegree">粗　细：</label><input class="pencil-input-1 ui-buttonset" type="text" name="pencilDegree" id="pencilDegree" value="1"><span style="position:absolute;left:90px;color:#acacac;">px</span><label class="pencil-label-2" for="pencilColor_choose">颜　色：</label><input class="pencil-input-2 pencilsetcolor tColorPicker ui-buttonset" type="text" id="pencilColor_choose" value="#ff0044" style="color:#ff0044;background-color:#ff0044;"><input class="pencil-hidden ui-buttonset" type="hidden" name="pencilColor" id="pencilColor" value="#ff0044"></li><li><label class="pencil-label-2" for="pencilOpacity">透明度：</label><input class="pencil-input-1 ui-buttonset" type="text" name="pencilOpacity" id="pencilOpacity" value="100"><span style="position:absolute;left:90px;color:#acacac;">%</span><label class="pencil-label-2" for="pencilOpacity" style="display:none;">层级：</label><select class="pencil-select" id="pencilLevel" name="pencilLevel" style="display:none;width:70px;"><option value="1000" selected="selected">应用上方</option><option value="200">应用下方</option></select></li></ul><div class="pencil-btn-5">删　除</div><div class="pencil-btn-1">确　认</div><div class="pencil-btn-2">取　消</div><div class="pencil-btn-3">确　认</div><div class="pencil-btn-4">取　消</div></div>').appendTo(b.b).hide().tooltip({
		...
		var a = b.tParseInt($("#pencilDegree").val()),
			...
			g = f.find("input[name='pencilStyle']:checked").val();

		1 > a && (a = 1), b.pencilLine.css({
		...
		}).attr("data-pts", a + ";" + RGBToHex(c, "#ff0044") + ";" + d + ";" + g + ";" + e), "ns" == b.pencilLine.attr("data-d") ? b.pencilLine.css({
		...
		}, 300))) : (b.pencilPointerDrag = !1, 0 == b.june.children(".pencilLineCreate").length ? b.june.children(".pencilLineEdit").removeClass("pencilLineEdit") : b.pencilLine.removeClass("pencilLineCreate").addClass("pencilLineEdit"), b.pencilStartX = null, b.pencilStartY = null)
		...
		if (b.pencilPointerDrag && b.pencilLine) {
			...
			}), b.pencilLine.attr("data-d", "ns").addClass("pl-ns").removeClass("pl-we"), b.pencilLine.children(".pencilPointer").children("img").attr("src", "images/pencilPointer2.gif").attr("height", "25").css("cursor", "ns-resize")) : (b.pencilLine.children(".pencilAssist").width(1).height(b.june.height()).offset({
			...
			}), b.pencilLine.attr("data-d", "we").removeClass("pl-ns").addClass("pl-we"), b.pencilLine.children(".pencilPointer").children("img").attr("src", "images/pencilPointer1.gif").attr("height", "15").css("cursor", "ew-resize")))
		...
		if (0 == b.june.children(".pencilLineCreate").length && 0 == b.june.children(".pencilLineEdit").length && (b.pencilLine = null, f.children("pencil-btn-1").is(":hidden") && f.hide()), b.pencilLine) if (b.pencilTime > 0) if (b.pencilPointerDrag = !1, b.pencilLine.removeClass("pencilLineCreate").addClass("pencilLineEdit"), b.pencilStartX = null, b.pencilStartY = null, b.pencilLine && !b.baseSetDrag) {
			...
			"we" == b.pencilLine.attr("data-d") ? (i = d + e / 2 - 120, h = c + 40) : (h = c + g / 2 - 102, i = d + 40), h + 205 > b.junebox.offset().top + b.junebox.height() && (h = b.pencilLine.offset().top - 205 - 10), i + 240 > b.junebox.offset().left + b.junebox.width() && (i = b.pencilLine.offset().left - 240 - 10), f.css({
		...
		}), b.pencilLine.removeClass("pl-ns").addClass("pl-we"), b.pencilLine.children(".pencilPointer").children("img").attr("src", "images/pencilPointer1.gif").attr("height", "15").css("cursor", "ew-resize")) : (b.pencilLine.css({
		...
		}), b.pencilLine.addClass("pl-ns").removeClass("pl-we"), b.pencilLine.children(".pencilPointer").children("img").attr("src", "images/pencilPointer2.gif").attr("height", "25").css("cursor", "ns-resize")), b.june.children(".pencilLineEdit").removeClass("pencilLineEdit"), b.june.children(".pencilLineCreate").removeClass("pencilLineCreate"), b.june.children(".t-pencilLine").addClass("pencilLinePause"), b.pencilLine = null, b.pencilTime = 1, $("#mouseaction").children(":eq(0)").trigger("click")
