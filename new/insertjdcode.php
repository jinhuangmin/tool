...
$sql2 = "SELECT * from jd_linshi WHERE UserName='$userName' and Title='$title' and Fx='0'  ";
...
if($x>0){ 
 // echo $value;
$gai="update jd_linshi set Value='$value',SaveTime='$time' where UserName='$userName' and Title='$title' and Fx='0'  ";
    $res=mysql_query($gai);
    if(!$res){
   $sql3 = "SELECT * from jd_linshi WHERE UserName='$userName' and Title='$title' and Fx='0'  ";
...
if($x==0){
$xieru="INSERT INTO jd_linshi (UserName, Title , CreaTime , Value ,Fx) VALUES ('$userName', '$title' ,'$time' ,'$value' ,'$fx' )";
