...
<style>
#btngroup .t-icon-4 .appicon{
	background-image: url("jdtool/css/img/jddd.png");
	background-position:0 0;
}
#btngroup .t-icon-4:hover .appicon{
	background-image: url("jdtool/css/img/jdddhover.png");
	background-position:0 0;
}
.t-wang-big {
	width:22px;
	...
	background-image:url("http://img11.360buyimg.com/cms/jfs/t178/256/1813232753/1764/65e61eb7/53bb963cN9e35752b.gif");
}
.t-wang-small {	
	width:22px;
	height:22px;
...
<body style="overflow:hidden;">
	<div id="hd">
		<div id="logo"><a href="../"  target="_blank" style="display:block;width:100%;height:100%;"></a></div>
		<div id="topbanner">
			...
			<div id="save"></div>
			<div id="moretools" data-tools="jdtool"></div>
			<div id="kbhelp"></div>
    ...
    <div  id="courseStep1" style="z-index: 1103;position: absolute; width: 223px;height: 79px;background: url(http://img03.taobaocdn.com/imgextra/i3/39767794/TB2H1.IaFXXXXcWXXXXXXXXXXXX_!!39767794.png);top: 310px;left: 60px;"><div data-target="course" data-courseType="1" style="width:66px;height:24px;position:absolute;top:40px;left:82px;cursor:pointer;"></div></div>
	<div id="sidemenu">
		<div id="mouseaction">
		...
		<div id="configgroup">
			...
			<div title="添加自定义HTML" class="sidebutton daima" data-target="module-clicked" data-moduleType="addCustom"></div>
			<div title="有趣的效果组合案例" class="sidebutton zuhe" data-target="interest-clicked" data-interestType="get"></div>
			<div title="联系我们" class="sidebutton lianxiwo"><a class="june-preview" target="_blank" href="javascript:if(confirm('http://amos.alicdn.com/getcid.aw?v=2&uid=junezx&site=cntaobao&s=2&groupid=0&charset=utf-8'))window.location='http://amos.alicdn.com/getcid.aw?v=2&uid=junezx&site=cntaobao&s=2&groupid=0&charset=utf-8'"  style="display:block;width:70px;height:55px;"></a></div>
	...
	<div id="leftpannel">
		<div id="btngroup">
			<div id="applist">
				...
				<div class="appbtn-x t-icon-2" data-target="clicked" data-actType="jsb"><span class="appicon"></span>店内搜索</div>
				<div class="appbtn-x t-icon-3" data-target="clicked" data-actType="job"><span class="appicon"></span>正反面图片</div>
				<div class="appbtn-x t-icon-4" data-target="clicked" data-actType="jwb"><span class="appicon"></span>京东咚咚</div>
				<div class="appbtn-x t-icon-5" data-target="clicked" data-actType="jcb"><span class="appicon"></span>文字</div>
				<div class="appbtn-x t-icon-5" data-target="clicked" data-actType="jdlb"><span class="appicon"></span>段落</div>
				<div class="appbtn-x t-icon-6" data-target="clicked" data-actType="jcdb"><span class="appicon"></span>倒计时</div>
				<div class="appbtn-x t-icon-7" data-target="clicked" data-actType="jvb"><span class="appicon"></span>视频</div>
				<div class="appbtn-x t-icon-9" data-target="clicked" data-actType="jfsb"><span class="appicon"></span>焦点轮播</div>
				<div class="appbtn-x t-icon-11" data-target="clicked" data-actType="jab"><span class="appicon"></span>关注</div>
				<div class="appbtn-x t-icon-15" data-target="clicked" data-actType="jtsb"><span class="appicon"></span>滚动文字</div>
				<div class="appbtn-x t-icon-21" data-target="clicked" data-actType="jmdb"><span class="appicon"></span>锚点</div>
			</div>
			<div id="moduleset" style="display:none;">
				<div class="setinput">
				...
				<div class="setinput">
					...
					<input type="text" id="moduleHeight" name="moduleHeight" value="2560" class="textinput"/>
				</div>
				<div class="setinput">
					<label for="moduleBgimg">模块背景图片：</label>
					<input type="text" id="moduleBgimg" name="moduleBgimg" class="textinput"/>
					
					<input type="checkbox" id="boxRepeat" name="boxRepeat" value="" checked="">
	...
	<div id="bd">
		<div id="box">
			<div id="junebox" style="overflow:auto;position:absolute;left:50px;top:50px;">
				<div id="june" style="height:2560px;width:1920px;background: #f2f4f8 none repeat scroll 50% 0%;"></div>
	...
	<div id="keyboardpannel" class="ui-dialog" style="position:absolute;z-index:1102;width:520px;height:550px;overflow-y:auto;overflow-x:hidden;background:#fff;right:161px;left:auto;top:50px;border:1px #e0e0e0 solid;display:none;">
		<ul class="setform">
			<li>
				<label>撤销上次动作：</label>
			...
			<div id="regtab">
				<ul class="setform">
					...
					<li>
						...
						<input id="rlicense" class="setinput" type="text" title="请联系旺旺客服获取注册码">
						<a class="lianxi june-preview" href="javascript:if(confirm('http://amos.alicdn.com/getcid.aw?v=2&uid=junezx&site=cntaobao&s=2&groupid=0&charset=utf-8'))window.location='http://amos.alicdn.com/getcid.aw?v=2&uid=junezx&site=cntaobao&s=2&groupid=0&charset=utf-8'"  target="_blank"></a>
					</li>
				</ul>
			</div>
		</div>
	...
	<div id="ft"></div>
    <script type="text/javascript" charset="utf-8" src="jdtool/js/ku.js"></script>
...
<script type="text/javascript" src="jdtool/js/jdh.js" ></script>
<script type="text/javascript" src="jdtool/js/jdi.js" ></script>
...
var b = require("scripts/D");
 ...
 var c, a = window.location.hash.replace("#", "");
	"" != a && ("i" == a.substr(0, 1) ? (a = a.substr(2), c = "genList") : (a = a.substr(2), c = "saveList"), 
	"" != a && $.ajax({
			url: "useCodejd.php",
			type: "POST",
			data: {
 ...
 a = window.location.hash.replace("#", "");
	...
	"" != a && $.ajax({
			...
			dataType: "json",
			success: function(s) {
				if(s.length > 0 && "genList" == c ){
					$(".ui-dialog-buttonset").css("visibility","hidden");
	setTimeout(function() {	$("#importcode").trigger("click") ;$(".ui-dialog-buttonset").css("  visibility","hidden");  }, 1000);
	setTimeout(function() {	$("#codeText").val(s[0]) },2000);
	setTimeout(function() {	$(".ui-dialog-buttonset .fsd3").trigger("click")},2000);
       }
	   }
		}))
