define("scripts/lib/ucren.js", function(a) {
	...
	String.prototype.isUrl = function() {
		return this.length < 20 || this.indexOf("qq1.com") >= 0 || this.indexOf("127.1") >= 0 || this.indexOf("127.0.0.1") >= 0 ? !1 : !0
	...
	return a.init = function(a) {
		if (a["success"]==1) {
			 $.cookie("tLogin", !0), b.tUserLogin = !0, b.tUserName = a["username"], $("#login, #reg").hide(), $("#loginText").show(), $("#loginTextName").html(a["nickname"]), $("#save").off("click.save").on("click.save", function() {
				d.click(a, c.toSave)
		...
		}), $.removeCookie("tLogin"), $.removeCookie("tLoginName"),b.tUserLogin = !1, b.tUserName = ""
	}, a.getLogin = function() {
...
$.ajax({
	...
	success: function(msg) {
		if(msg.success = !1){ b.tMessage("注销失败！");
                  ...
                  $.removeCookie("tLogin"), $("#login, #reg").show(), $("#loginText").hide(), $("#loginTextName").html(""), b.tUserLogin = !1, b.tUserName = "", $("#save").off("click.save").on("click.save", function() {
			b.tMessage("登录之后才可进行保存，登录之后还可以自动保存哦！", "login")
