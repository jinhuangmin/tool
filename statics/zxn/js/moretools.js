...
$(function() {
	...
	var morepannel = '<div id="morepannel" class="ui-dialog" style="display:none;position:absolute;z-index:1102;width:180px;background:#f5f5f5;left:-2px;;top:28px;border:1px #e0e0e0 solid;">'+
		'<ul>'+
			'<li'+toolShow[0]+'><a class="june-preview" target="_blank" href="/2.0/index.php">模板装修辅助工具</a></li>'+
			'<li'+toolShow[1]+'><a class="june-preview" target="_blank" href="/2.0/navcss.html">导航样式生成工具</a></li>'+
			'<li'+toolShow[2]+'><a class="june-preview" target="_blank" href="/2.0/color.html">色码获取工具</a></li>'+
			'<li'+toolShow[3]+'><a class="june-preview" target="_blank" href="/2.0/jdtool.html">京东装修工具</a></li>'+
			'<li'+toolShow[4]+'><a class="june-preview" target="_blank" href="/2.0/bgfixed.html">固定背景生成工具</a></li>'+
			'<li'+toolShow[5]+'><a class="june-preview" target="_blank" href="/side.php">侧边栏装修工具</a></li>'+
			'<li'+toolShow[6]+'><a class="june-preview" target="_blank" href="/gm/">手机端链接转换工具</a></li>'+
		'</ul>'+
	'</div>';
	var oldhtml = "";
