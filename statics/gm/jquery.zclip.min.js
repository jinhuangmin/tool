...
"zclip-"+this.movieId;jQuery(this.domElement).data("zclipId","zclip-"+this.movieId);var d=this.div.style;d.position="absolute";d.left=""+e.left+"px";d.top=""+e.top+"px";d.width=""+e.width+"px";d.height=""+e.height+"px";d.zIndex=a;if("object"==typeof c)for(addedStyle in c)d[addedStyle]=c[addedStyle];b.appendChild(this.div);this.div.innerHTML=this.getHTML(e.width,e.height)},getHTML:function(a,b){var c="",e="id="+this.id+"&width="+a+"&height="+b;if(navigator.userAgent.match(/MSIE/))var d=location.href.match(/^https/i)?
