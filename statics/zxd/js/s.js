...
define("scripts/little.js", function(a) {
	...
	return a.thumbImport = function(a) {
		...
		$("#junebox").scrollTop(0).scrollLeft(0), b.tLoading(!0), "rePair" != c ? b.tUserLogin && "" != b.tUserName ? (b.insertID && "" != b.insertID && (b.tLoading(!1), b.tMessage('分享成功, 您的作品地址为: <a class="june-preview" href="http://junezx.com/2.0/previewP.php?ID=' + b.insertID + '" target="_blank">http://junezx.com/2.0/previewP.php?ID=' + b.insertID + "</a>,您可以将此地址发给您的好友！")), $.post("getsnap", {
			...
			success: function(a) {
				a ? (b.tLoading(!1), b.tMessage('分享成功, 您的作品地址为: <a class="june-preview" href="http://junezx.com/2.0/previewP.php?ID=' + a + '" target="_blank">http://junezx.com/2.0/previewP.php?ID=' + a + "</a>,您可以将此地址发给您的好友！"), $.post("getsnap", {
					userName: b.tUserName,
					ID: a
				}, function() {
