    ...
    a["success"] ? (JUNEZX__USERSTATUS = !0, JUNEZX__USERNAME = a['username'], $("#nologin").hide(), $("#logged").show(), $("#userInfo").html( a['nickname']+"("+a['username']+")"), $.ajax({
        ...
        success: function(b) {
            ...
            if (b) {
                ...
                (!e || e - o > 6e5) && 10 > g && (c += '<div class="lg-part" data-ID="' + b.data[k].ID + '">' + '<div class="lg-time clear"><span class="lg-time-label">生成时间</span><span class="lg-time-text">' + b.data[k].CreatTime + '</span><span class="lg-time-use" title="应用"><a href="tool/index.php#s_' + b.data[k].ID + '" target="_blank"></a></span><span class="lg-time-preview" title="预览"><a href="tool/previewZ.php?ID=' + b.data[k].ID + '" target="_blank"></a></span></div>' + "</div>", e = o, g++);
                ...
                c += '<div class="lg-part" data-ID="' + b.saveData[k].ID + '">' + '<div class="lg-time">' + '<span class="lg-time-label">' + b.saveData[k].saveName + "</span>" + '<span class="lg-time-text">' + b.saveData[k].saveTime2 + "</span>" + '<span class="lg-time-use" title="应用"><a href="tool/index.php#s_' + b.saveData[k].ID + '" target="_blank"></a></span>' + '<span class="lg-time-preview" title="预览"><a href="tool/previewZ.php?ID=' + b.saveData[k].ID + '" target="_blank"></a></span>' + "</div>" + "</div>";
                for ($("#userInfo_saveList").html(c + '<div class="lg-last"><span class="lg-more" id="saveMore">查看更多</span></div><div id="saveMoreDialog" style="display:none;"></div>'), c = "", k = 0; i > k; k++) 10 > j && (c += '<div class="lg-part" data-ID="' + b.collectData[k].ID + '">' + '<div class="lg-time ddfffe clear"><span class="lg-time-img"><img src="' + b.collectData[k].url + '"></span><span class="lg-time-text wdssd">' + b.collectData[k].author + '</span><span class="lg-time-use" title="应用"><a href="tool/index.php#i_' + b.collectData[k].ID + '" target="_blank"></a></span><span class="lg-time-preview" title="预览"><a href="tool/previewI.php?id=' + b.collectData[k].ID + '" target="_blank"></a></span></div>' + "</div>", j++),
                ...
                $("#genMore").on("click",
                function() {
                    tAjaxDialog(540, "genMoreDialog", "生成列表", "zxn/api/userList", {
                        type: "gen",
                    ...
                    function(b, c) {
                        ...
                        if (a) {
							...
							h = 0; g > h; 
							h++) 
							d += '<div class="lg-more-part" data-ID="' + b.data[h].ID + '">' + '<div class="lg-more-box"><span class="lg-more-label">生成时间</span><span class="lg-time-text">' + b.data[h].CreatTime + '</span><span class="lg-more-use" title="应用"><a href="tool/index.php#i_' + b.data[h].ID + '" target="_blank"></a></span><span class="lg-time-preview" title="预览"><a href="tool/previewI.php?id=' + b.data[h].ID + '" target="_blank"></a></span></div>' + "</div>";
                            ...
                            function() {
                                ...
                                a != b.page && tAjaxDialog(540, "genMoreDialog", "生成列表", "zxn/api/userList", {
                                    type: "gen",
                                    username: JUNEZX__USERNAME,
                                    page: a
                                },
                ...
                $("#saveMore").on("click",
                function() {
                    tAjaxDialog(600, "saveMoreDialog", "保存列表", "zxn/api/userList", {
                        type: "save",
                        username: JUNEZX__USERNAME
                    },
                    function(b, c) {
                        ...
                        if (a) {
                            ...
                            d += '<div class="lg-more-part" data-ID="' + b.data[h].ID + '">' + '<div class="lg-more-box">' + '<span class="lg-more-label">' + b.data[h].saveName + "</span>" + '<span class="lg-more-text">' + m + "</span>" + '<span class="lg-more-use sxu2" title="应用"><a href="tool/index.php#s_' + b.data[h].ID + '" target="_blank"></a></span>' + '<span class="lg-more-preview sxp2" title="预览"><a href="tool/previewZ.php?ID=' + b.data[h].ID + '" target="_blank"></a></span>' + "</div>" + "</div>";
                            ...
                            function() {
                                var a = parseInt($(this).children("a.on").html(), 10);
                                a != b.page && tAjaxDialog(600, "saveMoreDialog", "保存列表", "zxn/api/userList", {
                                    type: "save",
                                    username: JUNEZX__USERNAME,
                                    page: a
                                },
                ...
                $("#faverMore").on("click",
                function() {
                    tAjaxDialog(800, "faverMoreDialog", "收藏列表", "zxn/api/userList", {
                        type: "faver",
                        username: JUNEZX__USERNAME
                    },
                    function(b, c) {
                        ...
                        if (a) {
							...
							f = Math.ceil(e / 8), 
							g = 0; e > g; g++)
							 d += '<div class="lg-more-part" data-ID="' + b.data[g].ID + '">' + '<div class="lg-more-box"><span class="lg-more-img"><img src="grsc/images/s.gif" data-lsrc="' + b.data[g].url + '" /></span><span class="lg-more-label">' + b.data[g].author + '</span><span class="lg-more-use sxu1" title="应用"><a href="tool/index.php#i_' + b.data[g].ID + '" target="_blank"></a></span><span class="lg-more-preview sxp1" title="预览"><a href="tool/previewI.php?id=' + b.data[g].ID + '" target="_blank"></a></span></div>' + "</div>";
