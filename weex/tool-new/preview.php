...
<body data-code='<? echo $_postCode;?>'>
    <div class="content">
        <div class="hd" style="text-align: center; line-height: 160px;background: #eff2f7;"><a href="https://wangpu.taobao.com/wirelessPageList.htm" target="_blank" style="color: #999; font-size: 14px; text-decoration:none;">提示：真实预览效果以店铺装修后台发布二维码扫码为准，页面效果<span style="color:#0faaf6;">仅供参考</span>哦！</a></div>
        <div class="bd">
