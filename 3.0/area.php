			...
			<div id="tabs-1">
				<ul class="setform">
					...
					<li>
						...
						<input id="ibeli1" class="setinput " type="text" title="该应用的名称，允许修改，用于在图层面板中标识应用" required junezx_vali_str="true" name="appLabel" value="<?=$_POST['appLabel']?>" />
					</li>
					<li>
...
if($bgp=='50% 50%'){$bgptxt='居中';}
			...
			<div id="tabs-2">
				<ul class="setform">
					...
					<li>
						<label for="outlineSpeed">鼠标经过显示速度：</label>
						<select id="outlineSpeed" name="outlineSpeed">
							<option style="display:none;" value="trans0s" <? if($_POST['outlineSpeed']=='trans0s'){echo'selected="selected"';} ?>>立即显示</option>
							<option value="trans01s" <? if($_POST['outlineSpeed']=='trans01s'){echo'selected="selected"';} ?>>0.1秒</option>
							<option value="trans02s" <? if($_POST['outlineSpeed']=='trans02s'){echo'selected="selected"';} ?>>0.2秒</option>
							<option value="trans03s" <? if($_POST['outlineSpeed']=='trans03s'){echo'selected="selected"';} ?>>0.3秒</option>
							<option value="trans04s" <? if($_POST['outlineSpeed']=='trans04s'){echo'selected="selected"';} ?>>0.4秒</option>
							<option value="trans05s" <? if($_POST['outlineSpeed']=='trans05s'){echo'selected="selected"';} ?>>0.5秒</option>
							<option value="trans06s" <? if($_POST['outlineSpeed']=='trans06s'){echo'selected="selected"';} ?>>0.6秒</option>
							<option value="trans07s" <? if($_POST['outlineSpeed']=='trans07s'){echo'selected="selected"';} ?>>0.7秒</option>
							<option value="trans08s" <? if($_POST['outlineSpeed']=='trans08s'){echo'selected="selected"';} ?>>0.8秒</option>
							<option value="trans09s" <? if($_POST['outlineSpeed']=='trans09s'){echo'selected="selected"';} ?>>0.9秒</option>
							<option value="trans1s" <? if($_POST['outlineSpeed']=='trans1s'){echo'selected="selected"';} ?>>1秒</option>
							<option value="trans1d1s" <? if($_POST['outlineSpeed']=='trans1d1s'){echo'selected="selected"';} ?>>1.1秒</option>
							<option value="trans1d2s" <? if($_POST['outlineSpeed']=='trans1d2s'){echo'selected="selected"';} ?>>1.2秒</option>
							<option value="trans1d3s" <? if($_POST['outlineSpeed']=='trans1d3s'){echo'selected="selected"';} ?>>1.3秒</option>
							<option value="trans1d4s" <? if($_POST['outlineSpeed']=='trans1d4s'){echo'selected="selected"';} ?>>1.4秒</option>
							<option value="trans1d5s" <? if($_POST['outlineSpeed']=='trans1d5s'){echo'selected="selected"';} ?>>1.5秒</option>
							<option value="trans1d6s" <? if($_POST['outlineSpeed']=='trans1d6s'){echo'selected="selected"';} ?>>1.6秒</option>
							<option value="trans1d7s" <? if($_POST['outlineSpeed']=='trans1d7s'){echo'selected="selected"';} ?>>1.7秒</option>
							<option value="trans1d8s" <? if($_POST['outlineSpeed']=='trans1d8s'){echo'selected="selected"';} ?>>1.8秒</option>
							<option value="trans1d9s" <? if($_POST['outlineSpeed']=='trans1d9s'){echo'selected="selected"';} ?>>1.9秒</option>
							<option value="trans2s" <? if($_POST['outlineSpeed']=='trans2s'){echo'selected="selected"';} ?>>2秒</option>
							<option value="trans2d2s" <? if($_POST['outlineSpeed']=='trans2d2s'){echo'selected="selected"';} ?>>2.2秒</option>
							<option value="trans2d5s" <? if($_POST['outlineSpeed']=='trans2d5s'){echo'selected="selected"';} ?>>2.5秒</option>
							<option value="trans2d8s" <? if($_POST['outlineSpeed']=='trans2d8s'){echo'selected="selected"';} ?>>2.8秒</option>
							<option value="trans3s" <? if($_POST['outlineSpeed']=='trans3s'){echo'selected="selected"';} ?>>3秒</option>
							<option value="trans4s" <? if($_POST['outlineSpeed']=='trans4s'){echo'selected="selected"';} ?>>4秒</option>
							<option value="trans5s" <? if($_POST['outlineSpeed']=='trans5s'){echo'selected="selected"';} ?>>5秒</option>
							<option value="trans6s" <? if($_POST['outlineSpeed']=='trans6s'){echo'selected="selected"';} ?>>6秒</option>
							<option value="trans7s" <? if($_POST['outlineSpeed']=='trans7s'){echo'selected="selected"';} ?>>7秒</option>
							<option value="trans8s" <? if($_POST['outlineSpeed']=='trans8s'){echo'selected="selected"';} ?>>8秒</option>
							<option value="trans9s" <? if($_POST['outlineSpeed']=='trans9s'){echo'selected="selected"';} ?>>9秒</option>
							<option value="trans10s" <? if($_POST['outlineSpeed']=='trans10s'){echo'selected="selected"';} ?>>10秒</option>
							<option value="trans30s" <? if($_POST['outlineSpeed']=='trans30s'){echo'selected="selected"';} ?>>30秒</option>
							<option value="trans60s" <? if($_POST['outlineSpeed']=='trans60s'){echo'selected="selected"';} ?>>60秒</option>
							<option value="trans300s" <? if($_POST['outlineSpeed']=='trans300s'){echo'selected="selected"';} ?>>300秒</option>
							<option value="trans600s" <? if($_POST['outlineSpeed']=='trans600s'){echo'selected="selected"';} ?>>600秒</option>
						</select>
					</li>
					<li>
   ...
   <? $popupPosition0=$_POST['popupConfig']['popupPosition'];$popupPosition1=str_replace(",","",$popupPosition0);$popupPosition=str_replace("'","",$popupPosition1);?> 
