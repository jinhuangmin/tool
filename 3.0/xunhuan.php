<form id="tForm" form-data="jxdb" method="post" >
...
?> 
					...
					<li>
						<label for="rds1">动画循环方式：</label>
						<div id="rds1">
							<input type="radio" id="rxds1" name="css1Type" value="normal" <?=$_POST['css1Type']=='normal'?'checked="checked"':'' ?> />
							<label for="rxds1" title="">来回循环</label>
							<input type="radio" id="rxds2" name="css1Type" value="j-a" <?=$_POST['css1Type']=='j-a'?'checked="checked"':'' ?>>
							<label for="rxds2" title="">单向循环</label>
						</div>
					</li>
					<li>
						...
						<div id="rd1">
							...
							<input type="radio" id="r2" name="displayMode" value="june-mr-fo0" <?=$_POST['displayMode']=='june-mr-fo0'?'checked="checked"':'' ?>>
							<label for="r2" title="">淡出闪动</label>
							<input type="radio" id="r3" name="displayMode" value="june-mr-fo1 june-box-fadein" <?=$_POST['displayMode']=='june-mr-fo1 june-box-fadein'?'checked="checked"':'' ?>>
							<label for="r3" title="">淡入闪动</label>
						</div>
					</li>
				...
				<select style="width:98px;" id="cssModeY_num" name="cssModeY_num" <?=$dishy?>>
					...
					<li>
						...
						<select id="cssMode" name="cssMode">
							...
							<option value="june-mr-fr2" <? if($_POST['cssMode']=='june-mr-fr2'){echo'selected="selected"';} ?>>逆时针旋转2度</option>
							<option value="june-mr-fr5" <? if($_POST['cssMode']=='june-mr-fr5'){echo'selected="selected"';} ?>>逆时针旋转5度</option>
                            <option value="june-mr-fr10" <? if($_POST['cssMode']=='june-mr-fr10'){echo'selected="selected"';} ?>>逆时针旋转10度</option>
                            <option value="june-mr-fr20" <? if($_POST['cssMode']=='june-mr-fr20'){echo'selected="selected"';} ?>>逆时针旋转20度</option>
                            <option value="june-mr-fr30" <? if($_POST['cssMode']=='june-mr-fr30'){echo'selected="selected"';} ?>>逆时针旋转30度</option>
                            <option value="june-mr-fr40" <? if($_POST['cssMode']=='june-mr-fr40'){echo'selected="selected"';} ?>>逆时针旋转40度</option>
                            <option value="june-mr-fr50" <? if($_POST['cssMode']=='june-mr-fr50'){echo'selected="selected"';} ?>>逆时针旋转50度</option>
                            <option value="june-mr-fr60" <? if($_POST['cssMode']=='june-mr-fr60'){echo'selected="selected"';} ?>>逆时针旋转60度</option>
                            <option value="june-mr-fr70" <? if($_POST['cssMode']=='june-mr-fr70'){echo'selected="selected"';} ?>>逆时针旋转70度</option>
                            <option value="june-mr-fr80" <? if($_POST['cssMode']=='june-mr-fr80'){echo'selected="selected"';} ?>>逆时针旋转80度</option>
                            <option value="june-mr-fr90" <? if($_POST['cssMode']=='june-mr-fr90'){echo'selected="selected"';} ?>>逆时针旋转90度</option>
                            <option value="june-mr-fr120" <? if($_POST['cssMode']=='june-mr-fr120'){echo'selected="selected"';} ?>>逆时针旋转120度</option>
							<option value="june-mr-fr180" <? if($_POST['cssMode']=='june-mr-fr180'){echo'selected="selected"';} ?>>逆时针旋转180度</option>
							<option value="june-mr-fr270" <? if($_POST['cssMode']=='june-mr-fr270'){echo'selected="selected"';} ?>>逆时针旋转270度</option>
							<option value="june-mr-fr360" <? if($_POST['cssMode']=='june-mr-fr360'){echo'selected="selected"';} ?>>逆时针旋转360度</option>
							<option value="june-mr-fr720" <? if($_POST['cssMode']=='june-mr-fr720'){echo'selected="selected"';} ?>>逆时针旋转720度</option>
						</select>
					</li>
					<li>
						<label for="cssMode_sf">缩放特效：</label>
						<select id="cssMode_sf" name="cssMode_sf">
							<option value="" selected="selected">无效果</option>
							<option value="june-mr-sf0" <? if($_POST['cssMode_sf']=='june-mr-sf0'){echo'selected="selected"';} ?>>缩小至消失</option>
							<option value="june-mr-sf02" <? if($_POST['cssMode_sf']=='june-mr-sf02'){echo'selected="selected"';} ?>>缩小至0.2倍</option>
							<option value="june-mr-sf04" <? if($_POST['cssMode_sf']=='june-mr-sf04'){echo'selected="selected"';} ?>>缩小至0.4倍</option>
							<option value="june-mr-sf05" <? if($_POST['cssMode_sf']=='june-mr-sf05'){echo'selected="selected"';} ?>>缩小至0.5倍</option>
							<option value="june-mr-sf06" <? if($_POST['cssMode_sf']=='june-mr-sf06'){echo'selected="selected"';} ?>>缩小至0.6倍</option>
							<option value="june-mr-sf08" <? if($_POST['cssMode_sf']=='june-mr-sf08'){echo'selected="selected"';} ?>>缩小至0.8倍</option>
							<option value="june-mr-sf09" <? if($_POST['cssMode_sf']=='june-mr-sf09'){echo'selected="selected"';} ?>>缩小至0.9倍</option>
							<option value="june-mr-sf095" <? if($_POST['cssMode_sf']=='june-mr-sf095'){echo'selected="selected"';} ?>>缩小至0.95倍</option>
							<option value="june-mr-sf098" <? if($_POST['cssMode_sf']=='june-mr-sf098'){echo'selected="selected"';} ?>>缩小至0.98倍</option>
							<option value="june-mr-sf1" <? if($_POST['cssMode_sf']=='june-mr-sf1'){echo'selected="selected"';} ?>>原始尺寸</option>
							<option value="june-mr-sf102" <? if($_POST['cssMode_sf']=='june-mr-sf102'){echo'selected="selected"';} ?>>放大至1.02倍</option>
							<option value="june-mr-sf105" <? if($_POST['cssMode_sf']=='june-mr-sf105'){echo'selected="selected"';} ?>>放大至1.05倍</option>
							<option value="june-mr-sf110" <? if($_POST['cssMode_sf']=='june-mr-sf110'){echo'selected="selected"';} ?>>放大至1.1倍</option>
							<option value="june-mr-sf120" <? if($_POST['cssMode_sf']=='june-mr-sf120'){echo'selected="selected"';} ?>>放大至1.2倍</option>
							<option value="june-mr-sf150" <? if($_POST['cssMode_sf']=='june-mr-sf150'){echo'selected="selected"';} ?>>放大至1.5倍</option>
							<option value="june-mr-sf180" <? if($_POST['cssMode_sf']=='june-mr-sf180'){echo'selected="selected"';} ?>>放大至1.8倍</option>
							<option value="june-mr-sf200" <? if($_POST['cssMode_sf']=='june-mr-sf200'){echo'selected="selected"';} ?>>放大至2倍</option>
						</select>
					</li>
					<li>
						<label for="cssMode_fz">翻转特效：</label>
						<select id="cssMode_fz" name="cssMode_fz">
							<option value="" <? if($_POST['cssMode_fz']==''){echo'selected="selected"';} ?>>无效果</option>
							<option value="june-mr-fx" <? if($_POST['cssMode_fz']=='june-mr-fx'){echo'selected="selected"';} ?>>横向翻转</option>
							<option value="june-mr-fy" <? if($_POST['cssMode_fz']=='june-mr-fy'){echo'selected="selected"';} ?>>纵向翻转</option>
							<option value="june-mr-fxy" <? if($_POST['cssMode_fz']=='june-mr-fxy'){echo'selected="selected"';} ?>>横向纵向同时翻转</option>
						</select>
					</li>
					<li>
